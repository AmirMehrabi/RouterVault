...
class WirelessClientFactory extends Factory
{
    public function definition(): array
    {
        ...
        return [
            ...
            'device_identity' => fake()->optional()->bothify('Tower-##-AP-####'),
            'device_mac_address' => fake()->optional()->macAddress(),
            'device_version' => fake()->optional()->randomElement(['6.49.10', '7.16.2', '7.18']),
            ...
            'management_ip_address' => fake()->boolean(70) ? fake()->ipv4() : null,
            'management_port' => 8728,
            'management_protocol' => 'routeros_api',
            ...
            'last_discovered_at' => fake()->boolean(70) ? now()->subMinutes(fake()->numberBetween(5, 180)) : null,
            'last_management_status' => fake()->optional()->randomElement(['success', 'failed']),
            'last_management_message' => fake()->optional()->sentence(),
            'last_management_ran_at' => fake()->boolean(60) ? now()->subMinutes(fake()->numberBetween(5, 180)) : null,
