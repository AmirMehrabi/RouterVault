...
$classes = match($status) {
    ...
    'pending', 'warning', 'partial_success', 'partial_failed' => 'bg-yellow-100 text-yellow-800 border-yellow-200',
    ...
    'info', 'building', 'processing', 'running' => 'bg-blue-100 text-blue-800 border-blue-200',
