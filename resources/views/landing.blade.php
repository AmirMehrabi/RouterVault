    ...
    <div class="min-h-screen">
        <header class="border-b border-slate-200 bg-white">
            <div class="mx-auto flex max-w-7xl items-center justify-between gap-6 px-4 py-4 sm:px-6 lg:px-8">
                <div class="flex items-center gap-4">
                    <div class="flex h-11 w-11 items-center justify-center border border-blue-700 bg-blue-600 text-lg font-bold text-white">SB</div>
                    <div>
                        <p class="text-lg font-bold text-slate-900">SkyBase</p>
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('auth.login') }}" class="inline-flex items-center justify-center border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 transition hover:border-slate-400 hover:bg-slate-50">
                        ورود
                    </a>
                    <a href="{{ route('auth.register') }}" class="inline-flex items-center justify-center bg-blue-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-blue-700">
                        شروع استفاده
                    </a>
                </div>
            </div>
        ...
        <main>
            <section class="border-b border-slate-200 bg-white">
                <div class="mx-auto grid max-w-7xl gap-10 px-4 py-10 sm:px-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(420px,0.85fr)] lg:px-8 lg:py-16">
                    <div class="order-2 lg:order-1">
                        ...
                        <div class="mt-8 grid gap-5 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
                            ...
                            <div class="border border-blue-200 bg-blue-600 p-5 text-white">
                                <p class="text-sm font-semibold uppercase tracking-[0.28em] text-blue-100">تمرکز اصلی</p>
                        ...
                        <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                            <a href="{{ route('auth.register') }}" class="inline-flex items-center justify-center bg-blue-600 px-6 py-3 text-sm font-bold text-white transition hover:bg-blue-700">
                                ایجاد حساب و شروع
                            </a>
                            <a href="{{ route('auth.login') }}" class="inline-flex items-center justify-center border border-slate-300 px-6 py-3 text-sm font-bold text-slate-700 transition hover:bg-slate-100">
                                ورود به داشبورد
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="order-1 lg:order-2">
                        <div class="border border-slate-200 bg-slate-950 p-4 text-white shadow-sm">
                            ...
                            <div class="mt-4 grid gap-4 xl:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
                                <div class="space-y-4">
                                    ...
                                    <div class="grid gap-4 md:grid-cols-2">
                                        ...
                                        <div class="border border-blue-500/30 bg-blue-600/10 p-4">
            ...
            <section class="border-b border-slate-200 bg-slate-100">
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    <div class="grid gap-px border border-slate-200 bg-slate-200 md:grid-cols-4">
                ...
                <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                    <div class="grid gap-8 xl:grid-cols-[minmax(320px,0.85fr)_minmax(0,1.15fr)]">
                        <div class="border-l-4 border-blue-600 pl-5">
                            <p class="text-sm font-semibold uppercase tracking-[0.28em] text-blue-700">سه محور اصلی</p>
                        ...
                        <div class="grid gap-5 lg:grid-cols-3">
                            <article class="border border-slate-200 bg-slate-50 p-6 lg:mt-10">
                            ...
                            <article class="border border-blue-200 bg-blue-600 p-6 text-white">
                            ...
                            <article class="border border-slate-200 bg-slate-950 p-6 text-white lg:mt-16">
                ...
                <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                    <div class="grid gap-8 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
                        <div class="border border-slate-200 bg-white p-6">
                            <p class="text-sm font-semibold uppercase tracking-[0.28em] text-blue-700">چرخه عملیاتی</p>
                        ...
                        <div class="grid gap-px border border-slate-200 bg-slate-200">
                            <div class="grid gap-5 bg-white p-6 md:grid-cols-[96px_minmax(0,1fr)]">
                                <div class="bg-slate-950 px-4 py-5 text-center text-white">
                            ...
                            <div class="grid gap-5 bg-white p-6 md:grid-cols-[96px_minmax(0,1fr)]">
                                <div class="bg-blue-600 px-4 py-5 text-center text-white">
                            ...
                            <div class="grid gap-5 bg-white p-6 md:grid-cols-[96px_minmax(0,1fr)]">
                                <div class="bg-slate-200 px-4 py-5 text-center text-slate-900">
                    ...
                    <div class="grid gap-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
                        <div class="grid gap-6">
                            <div class="border border-slate-200 bg-slate-50 p-6">
                                <p class="text-sm font-semibold uppercase tracking-[0.28em] text-blue-700">برای تیم NOC و فنی</p>
                        ...
                        <div class="border border-slate-200 bg-slate-950 p-6 text-white">
                            <p class="text-sm font-semibold uppercase tracking-[0.28em] text-slate-400">نمونه نتیجه</p>
            ...
            <section id="audience" class="bg-slate-100">
                <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                    <div class="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
                        <div class="grid gap-px border border-slate-200 bg-slate-200 md:grid-cols-3">
                        ...
                        <div class="border border-blue-700 bg-blue-600 p-6 text-white">
                            <p class="text-sm font-semibold uppercase tracking-[0.28em] text-blue-100">آماده شروع؟</p>
                            ...
                            <div class="mt-6 grid gap-3">
                                <a href="{{ route('auth.register') }}" class="inline-flex items-center justify-center bg-white px-4 py-3 text-sm font-bold text-blue-700 transition hover:bg-blue-50">حساب جدید بسازید</a>
                                <a href="{{ route('auth.login') }}" class="inline-flex items-center justify-center border border-blue-300 px-4 py-3 text-sm font-bold text-white transition hover:bg-blue-700">ورود برای کاربران فعلی</a>
                            </div>
                        </div>
                    </div>
                </div>
